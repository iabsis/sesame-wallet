...
import { FooterActions, MainPanel, PanelContainer, PanelContent, PanelTitle, SectionContent } from "../../components/PageComponents";
  ...
  return (
    <MainPanel>
      <PanelContainer>
        ...
        <PanelContent>
          <SectionContent>
            <TextAreaTags tagifyRef={tagifyRef} placeholder={phrase.length.toString()} whitelist={allowedWords.current} onChange={handlePhraseChange} />
          </SectionContent>
          <CenteredSecondaryParagraph>
            {!isNextButtonActive() ? "Make sure to properly write down the 24 secret words. They are the key to your wallet." : "All good? Let's continue!"}
          </CenteredSecondaryParagraph>
        </PanelContent>
        {isNextButtonActive() && (
          <FooterActions>
